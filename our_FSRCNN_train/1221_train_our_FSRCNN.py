...
from TCL_SuperResolution_Model_our_FSRCNN_save_epoch_loss_logger import TCL_SuperResolution
...
def parse_args():
    ...
    parser.add_argument('--model_name', type=str, default='FSRCNN',
                        choices=['Net', 'Net_new4', 'Net_new3','FSRCNN','FSRCNN_d1','FSRCNN_d2','FSRCNN_ps1', 'FSRCNN_ps2_HN'], help='The type of model')
    ...
    # loss parameters
    parser.add_argument('--loss', nargs="+", type=str, default=['l1','ssim'], help = 'loss function: l1, ssim, gradient loss, vgg loss, color loss, tv loss mse loss cobi')
    parser.add_argument('--lambda_l1', type=float, default=1, help = 'weighting of l1 loss')
    parser.add_argument('--lambda_ssim', type=float, default=0.2, help = 'weighting of ssim loss')
