...
from TCL_SuperResolution_Model_1207_Cobi_loss import TCL_SuperResolution
...
def parse_args():
    ...
    parser.add_argument('--loss_func', type=str, default='ssim') ##mse, ssim, Cobi
    parser.add_argument('--GT_dir', type=str, default='./Visstyle_Dataset_Steven/HR')
    parser.add_argument('--LR_dir', type=str, default='./Visstyle_Dataset_Steven/LR')
    ...
    parser.add_argument('--model_save_dir', type=str, default='./1120_Visstyle_Steven_dataset_only_random_crop_multi_GPU', help='Directory name to save models')
    parser.add_argument('--img_save_dir', type=str, default='./experiments/1110', help='Directory name to save validation pictures')
    parser.add_argument('--pretrained_model', type=str, default='tcl_x4_bright.pkl', help='Directory name to pretrained model')
